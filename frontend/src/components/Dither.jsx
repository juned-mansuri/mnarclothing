...
// Fixed RetroEffect implementation to avoid circular references
class RetroEffectImpl extends Effect {
  ...
  update(renderer, inputBuffer, deltaTime) {
    // Safe implementation to avoid circular references
    const size = renderer.getSize(new THREE.Vector2());
    this.uniforms.get("resolution").value.set(size.width, size.height);
  }
}

// Wrap the effect without trying to serialize circular structures
...
function DitheredWaves({
  ...
  // Update uniforms on size changes
  useEffect(() => {
