...
const CategoryCollection = ({ preSelectedCategory = null, title }) => {
  ...
  const applyFilter = () => {
    ...
    // Apply category filter (always applied if preSelectedCategory exists)
        ...
        >
          ...
          <div className="flex flex-col gap-2 text-sm font-light text-gray-700">
            <p className="flex gap-2">
              <input value={"Topwear"} type="checkbox" className="w-3" onChange={toggleSubCategory} />
              Topwear
            </p>
            <p className="flex gap-2">
              <input value={"Bottomwear"} type="checkbox" className="w-3" onChange={toggleSubCategory} />
              Bottomwear
            </p>
            <p className="flex gap-2">
